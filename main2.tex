...
{\textcolor{hrefBlue}{automatic vulnerability scanning and security controls}}
...
\href{https://www.palantir.com/docs/foundry/data-integration/builds/}
{\textcolor{hrefBlue}{builds}}
...
\newline
and \#1 rank in KorQuAD-v2 (similar to v1, but with longer context) with F\textsubscript{1} of 88.09 as of Jun 2020.
...
\resumeItemListStart
\resumeItem{Graduated top-5 university in South Korea with \textbf{cum laude} honors}
\resumeItem{Received UNIST Global Dream Scholarship: free tuition + \$300 monthly allowance}
\resumeItemListEnd
\resumeSubHeadingListEnd
