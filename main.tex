...
\cveventflat
    ...
    {\textbf{Bereke}, South Korea}
    {July 2018 -- present}
    {South Korea}
\medskip
\normalsize
\begin{itemize}
\item Building real-time game show trivia application supported by \$4000 Unicorn Scholarship
\item Developing scalable back-end infrastructure for live-streaming
\textbf{[Node.js, React, Redis, Firebase, AWS]}
\end{itemize}
